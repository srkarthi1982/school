...
// A quiz or form, de-duplicated across its lesson/course associations.
interface AllItem {
  kind: Tab
...
export default function CourseSelectionEvaluationAllPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null)
    try {
      const ev = await ensureInstanceEvaluation(courseId)
  ...
  const items: AllItem[] = useMemo(() => {
    // De-duplicate by the underlying quiz/form so a single one linked to
