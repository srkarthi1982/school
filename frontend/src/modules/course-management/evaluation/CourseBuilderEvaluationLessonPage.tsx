...
export default function CourseBuilderEvaluationLessonPage() {
  ...
  const evaluationPath = `/course-management/course-builder/${masterId}/category/evaluation`
  ...
  }, [masterId, lessonId, isCourse, lessonFromState, setEvaluation, setCurrentLessonId])
