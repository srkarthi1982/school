...
import type { EvaluationLesson } from './evaluation-api'
...
export default function CourseBuilderEvaluationPage() {
  ...
  useEffect(() => {
    ...
    ensureCourseMasterEvaluation(masterId)
      .then((data) => {
        if (cancelled) return
        setEvaluation(data.id, data.status, data.course_master_completion, data.title)
          ...
          {loading && lessons.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-[12.5px] text-muted mb-4 max-w-md">
                You can still assign quizzes to the whole course above. To organise by lesson, create
                lessons in the Course Information → Lesson Creation step first.
              </p>
              <button
                type="button"
