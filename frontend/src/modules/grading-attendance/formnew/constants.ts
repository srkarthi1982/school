...
import { StudentResponseStatus, FormQuestionType, FormStatus } from "./types/form"
...
export const STATUS_COLORS: Record<FormStatus, { bg: string; text: string }> = {
  draft: { bg: 'rgba(245,158,11,0.12)', text: '#D97706' },
  published: { bg: 'rgba(34,197,94,0.10)', text: '#16A34A' },
}

export const TYPE_COLORS: Record<FormQuestionType, { bg: string; text: string }> = {
