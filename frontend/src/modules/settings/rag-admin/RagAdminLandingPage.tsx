...
export default function RagAdminLandingPage() {
  ...
  return (
    <div className="flex flex-col gap-4 lg:min-h-0">
      <SectionHeader
        ...
        title={t('nav.ragAdmin')}
        description={t('ragAdmin.landingDesc')}
      />
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex items-center gap-1 text-[12px] font-semibold text-accent">
        {t('ragAdmin.open')} <HiOutlineChevronRight className="text-[14px] group-hover:translate-x-0.5 transition-transform" />
      </span>
    </button>
  )
}
